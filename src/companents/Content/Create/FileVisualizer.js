...
function FileVisualizer(props) {
    return (
        <div className={fileResultStyle.file}>
            <div className={fileResultStyle.fileIcon}>
            ...
            <div className={fileResultStyle.fileName}>{props.fileName}</div>
        </div>
    )
}
